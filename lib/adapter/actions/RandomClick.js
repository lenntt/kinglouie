...
class RandomClick {
    ...
    constructor(driver, config = {timeout: DEFAULT_TIMEOUT, screenshot: false, decorate: false}) {
        this._driver = driver;
        this._config = config;
            ...
            try {
                ...
                while (allClickables.length > 0) {
                    ...
                    try {
                        ...
                        var elementData = await ElementData.fromWebElement(clickable, this._config.screenshot);
